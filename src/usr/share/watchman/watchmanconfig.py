...
class WatchmanConfig:
    ...
    def __init__(self, config_file):
        """Reads the watchman subprocess configuration and exits the program if there is an
        error.
        """
        ...
        # By the time this method is called in the subprocess, the logging should already be
        #   started.  However, the main process still needs to validate the subprocess's
        #   logging parameters.  Hence why the result is simply discarded.
        ...
        self.still_running_email_max_delay = config_helper.verify_number_exists(
            config_file, 'still_running_email_max_delay')
        ...
        self.replacement_subtractor_creation_threshold = config_helper.verify_number_exists(
            config_file, 'replacement_subtractor_creation_threshold')
